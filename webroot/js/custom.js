...
jQuery(document).ready(function($){
	...
	$('.mainMenuButton').click(function(){
		...
		if(mainMenuStatus == 'closed' && mainMenuAnimation == 'complete'){
			...
			$('.mainMenuWrapper').stop(true, true).animate({top: headerHeight}, 500, 'easeOutQuart', function(){mainMenuStatus = 'open'; mainMenuAnimation = 'complete'});
			
		}else if(mainMenuStatus == 'open' && mainMenuAnimation == 'complete'){
			
			mainMenuAnimation = 'incomplete';
			$('.mainMenuWrapper').stop(true, true).animate({top: -mainMenuHeight + headerHeight}, 500, 'easeInQuart', function(){mainMenuStatus = 'closed'; mainMenuAnimation = 'complete'; $('.mainMenuWrapper').css('display', 'none'); });
